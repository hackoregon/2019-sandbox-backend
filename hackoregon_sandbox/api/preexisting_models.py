...
#    b28002_002m = models.FloatField(blank=True, null=True)
    total_subscriptions_dialup_only = models.FloatField(blank=True, null=True, db_column='b28002_003e')
#    b28002_003m = models.FloatField(blank=True, null=True)
    total_subscriptions_any_broadband = models.FloatField(blank=True, null=True, db_column='b28002_004e')
...
#    b28002_005m = models.FloatField(blank=True, null=True)
    total_subscriptions_cellular_data_only = models.FloatField(blank=True, null=True, db_column='b28002_006e')
...
#    b28002_009m = models.FloatField(blank=True, null=True)
    total_subscriptions_satellite_only = models.FloatField(blank=True, null=True, db_column='b28002_010e')
...
#    b28002_011m = models.FloatField(blank=True, null=True)
    total_access_without_subscriptions = models.FloatField(blank=True, null=True, db_column='b28002_012e')
#    b28002_012m = models.FloatField(blank=True, null=True)
    total_no_access = models.FloatField(blank=True, null=True, db_column='b28002_013e')
...
#    b28010_001m = models.FloatField(blank=True, null=True)
    total_has_computing_devices = models.FloatField(blank=True, null=True, db_column='b28010_002e')
...
#    b28010_005m = models.FloatField(blank=True, null=True)
    total_smartphone_nodesktop = models.FloatField(blank=True, null=True, db_column='b28010_006e')
#    b28010_006m = models.FloatField(blank=True, null=True)
    total_no_computer = models.FloatField(blank=True, null=True, db_column='b28010_007e')
